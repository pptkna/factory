...
const (
	...
	PaymentMethod_PAYMENT_METHOD_SBP PaymentMethod = 3
	// Кредитная карта
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x10transaction_uuid\x18\x01 \x01(\tR\x0ftransactionUuid*\xbf\x01\n" +
	"\rPaymentMethod\x12\x1e\n" +
	"\x1aPAYMENT_METHOD_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16PAYMENT_METHOD_UNKNOWN\x10\x01\x12\x17\n" +
	"\x13PAYMENT_METHOD_CARD\x10\x02\x12\x16\n" +
	"\x12PAYMENT_METHOD_SBP\x10\x03\x12\x1e\n" +
	"\x1aPAYMENT_METHOD_CREDIT_CARD\x10\x04\x12!\n" +
	"\x1dPAYMENT_METHOD_INVESTOR_MONEY\x10\x052W\n" +
	"\x0ePaymentService\x12E\n" +
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBIZGgithub.com/pptkna/rocket-factory/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
