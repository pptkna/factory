...
const (
	...
	Category_CATEGORY_UNKNOWN Category = 1
	// Двигатель
	Category_CATEGORY_ENGINE Category = 2
	// Топливо
	Category_CATEGORY_FUEL Category = 3
	// Иллюминатор
	Category_CATEGORY_PORTHOLE Category = 4
	// Крыло
	Category_CATEGORY_WING Category = 5
)
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04part\x18\x01 \x01(\v2\x12.inventory.v1.PartR\x04part\"\xbc\x01\n" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts*\x8c\x01\n" +
	"\bCategory\x12\x18\n" +
	"\x14CATEGORY_UNSPECIFIED\x10\x00\x12\x14\n" +
	"\x10CATEGORY_UNKNOWN\x10\x01\x12\x13\n" +
	"\x0fCATEGORY_ENGINE\x10\x02\x12\x11\n" +
	"\rCATEGORY_FUEL\x10\x03\x12\x15\n" +
	"\x11CATEGORY_PORTHOLE\x10\x04\x12\x11\n" +
	"\rCATEGORY_WING\x10\x052\xa8\x01\n" +
	"\x10InventoryService\x12F\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\x12L\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBMZKgithub.com/pptkna/rocket-factory/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0,  // 7: inventory.v1.PartsFilter.categories:type_name -> inventory.v1.Category
	7,  // 8: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartsFilter
